<div class="bg_gray">
		<div class="top_banner general">
			...
			<img src="../view/img/top_about.jpg" class="img-fluid" alt="">
		</div>
		<!--/top_banner-->
		...
		<div class="container margin_90_0">
			<div class="row justify-content-between align-items-center flex-lg-row-reverse content_general_row">
				<div class="col-lg-5 text-center">
					<figure><img src="../view/img/about_placeholder.jpg" data-src="../view/img/about_1.svg" alt="" class="img-fluid lazy" width="350" height="268"></figure>
				</div>
				<div class="col-lg-6">
			...
			<div class="row justify-content-between align-items-center content_general_row">
				<div class="col-lg-5 text-start">
					<figure><img src="../view/img/about_placeholder.jpg" data-src="../view/img/about_3.svg" alt="" class="img-fluid lazy" width="350" height="268"></figure>
				</div>
				<div class="col-lg-6">
					<h2>Per quot choro cetero eu</h2>
					<p class="lead">Eu qui mundi lucilius petentium, mea amet libris prodesset in.</p>
			...
			<div class="row justify-content-between align-items-center flex-lg-row-reverse content_general_row">
				<div class="col-lg-5 text-center">
					<figure><img src="../view/img/about_placeholder.jpg" data-src="../view/img/about_2.svg" alt="" class="img-fluid lazy" width="350" height="316"></figure>
				</div>
				<div class="col-lg-6">
					<h2>Per quot choro cetero eu</h2>
					<p class="lead">Eu qui mundi lucilius petentium, mea amet libris prodesset in.</p>
		...
		<div id="carousel-home">
			<div class="owl-carousel owl-theme">
				<div class="owl-slide cover" style="background-image: url(../view/img/testimonial_1.jpg);">
				...
				<!--/owl-slide-->
				<div class="owl-slide cover" style="background-image: url(../view/img/testimonial_2.jpg);">
					<div class="opacity-mask d-flex align-items-center" data-opacity-mask="rgba(0, 0, 0, 0.5)">
						<div class="container">
							<div class="row justify-content-center justify-content-md-start">
								<div class="col-lg-6 static">
				...
				<!--/owl-slide-->
				<div class="owl-slide cover" style="background-image: url(../view/img/testimonial_3.jpg);">
